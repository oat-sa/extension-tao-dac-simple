...
$.ajax({url:$form.attr("action"),type:"POST",data:$form.serialize(),global:!1}).done(function(){feedback().success(__("Permissions saved"))}).fail(function(jqXHR,textStatus,errorThrown){var error=httpErrorParser.parse(jqXHR,textStatus,errorThrown);feedback().error(error.message)}).complete(function(){$submitter.removeClass("disabled")})}})}};return mainCtrl});
